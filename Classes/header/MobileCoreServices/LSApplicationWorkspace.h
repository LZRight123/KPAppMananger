...
/// 0 = User 1 = System
- (NSArray <LSApplicationProxy *> *)applicationsOfType:(unsigned long long)arg1;
- (NSArray *)applicationsWithAudioComponents;
- (NSArray <LSApplicationProxy *> *)applicationsWithUIBackgroundModes; //开了后台运行的app
- (NSArray *)applicationsWithVPNPlugins;
...
- (bool)installApplication:(NSURL *)arg1 withOptions:(id)arg2 error:(NSError **)arg3;
- (bool)installApplication:(NSURL *)arg1 withOptions:(id)arg2 error:(NSError **)arg3 usingBlock:(void(^)(NSDictionary *progress, void *unknow) /* block */)arg4;
...
- (bool)uninstallApplication:(NSString *)bundleId withOptions:(id)arg2;
